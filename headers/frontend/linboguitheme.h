...
public:
    ...
    QColor glassBg() const;
    QColor glassBorder() const;
    QColor glassSubtleBg() const;
    QColor glassSubtleBorder() const;
    QColor textAt(int alpha) const;
    bool lowFxMode() const;
...
private:
    ...
    QMap<LinboTheme::ColorRole, QColor> _lightColors = {
        {LinboTheme::BackgroundColor, "#0a0a0a"},
        {LinboTheme::TextColor, "#fafafa"},
        {LinboTheme::ToolButtonColor, "#0081c6"},
        {LinboTheme::DisabledToolButtonColor, "#4a7a9e"},
        {LinboTheme::AccentColor, "#0081c6"}
    };

    QMap<LinboTheme::ColorRole, QColor> _darkColors = {
        {LinboTheme::TextColor, "#0a0a0a"},
        {LinboTheme::ToolButtonColor, "#4a7a9e"},
